...
__version__ = run_path('src/example_project/version.py')['__version__']
...
setup(
    ...
    description="A small example project created with the at-python-template.",
    license="proprietary",
    url="",
    packages=find_packages("src"),
    package_dir={"": "src"},
    package_data={'example_project': ['res/*']},
